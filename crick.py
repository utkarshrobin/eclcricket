    ...
    if query.data == 'solo_game':
        ...
        await query.edit_message_media(
            media=InputMediaPhoto(
                media='https://res.cloudinary.com/dxgfxfoog/image/upload/v1777710602/file_000000005a607208bd015e237540e8e3_iplfhm.png',
        ...
        await query.edit_message_media(
            media=InputMediaPhoto(
                media='https://res.cloudinary.com/dxgfxfoog/image/upload/v1777710675/file_0000000017e07208be22ea00fbd507ad_dbvkje.png',
                caption=text,
                parse_mode='HTML'
            ),
        ...
        await query.edit_message_text(f"✅ The captain chose to {dec_text} first!")
        ...
        await query.edit_message_text(f"✅ Match set for <b>{overs} Overs</b> per side!", parse_mode='HTML')
        ...
        if game and game.get('state') == 'PLAYING':
            await query.edit_message_caption(caption="❌ Match is already playing! Use /endmatch to stop it.")
            return
        if game:
            game['state'] = 'NOT_PLAYING'
        ...
        if votes >= 4:
            ...
            await query.edit_message_text(f"✅ Vote passed! Game Host successfully changed to <b>{game['host_vote_name']}</b>! 👑", parse_mode='HTML')
        else:
        ...
        if roll <= 60: # 60% WIDE
            ...
            await query.edit_message_text("🚨 <b>You bowled a NO BALL!</b>", parse_mode='HTML')
