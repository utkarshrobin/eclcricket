...
MEDIA = {
    ...
    'bowler_turn': 'https://media.giphy.com/media/pmidT2SShLszmxLhoA/giphy.gif',
...
async def soloscore_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(scorecard, parse_mode='HTML')
