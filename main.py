...
def commit_player_stats(game):
    ...
    # FIX: Safely retrieve players preventing KeyError if a team wasn't fully initialized when endmatch was triggered.
...
async def is_admin(chat, user_id):
    # FIX: Robust admin check checking both administrators array and individual member status
    try:
