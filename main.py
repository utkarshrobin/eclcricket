...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type == 'private':
        ...
        welcome_private = "Welcome to ELITE CRICKET BOT! 🏏\nYour ultimate Telegram Cricket experience."
        kb_private = [
        ...
        await update.message.reply_text(welcome_private, reply_markup=InlineKeyboardMarkup(kb_private))
        return
...
async def join_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if any(p['id'] == user.id for p in game['players']):
        await update.message.reply_text(f"⚠️ {user.first_name}, you are ALREADY in the queue for this match! ⏳🧍‍♂️")
        return
    ...
    if query.data == 'solo_game':
        ...
        if action == 'yes':
            ...
            if game_ref: 
                ...
                for prefix in ['autostart_', 'team_join_', 'queueremind_', 'afk10_', 'afk60_', 'afk90_']:
