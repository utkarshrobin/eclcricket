...
def commit_player_stats(game):
    ...
    for p in players:
        ...
        # Calculate derived stats from current match
        updates = {
            "total_runs": p['runs'],
...
async def create_team_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # CHANGED: Reduced timeout to 10 seconds per requirements
...
async def join_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(game['players']) == 1:
        ...
        # CHANGED: Reminder interval and first to 35 seconds per requirements
        ...
        if bowl_val == 'NO_BALL':
            ...
            if milestone_media:
                try:
                    ...
                    await context.bot.send_message(chat_id, milestone_text, parse_mode='HTML')
                ...
                if is_free_hit:
                    ...
                    if batter['runs'] == 0:
                        ...
                        try:
                             ...
                             await update.message.reply_text(duck_text, parse_mode='HTML')
