...
def generate_team_scorecard(game):
    ...
    for team_key, team_name in [('team_a', 'Team A 🔴'), ('team_b', 'Team B 🔵')]:
        ...
        text += f"<b>{team_name}</b> --> {team['score']}/{team['wickets']} ({played_overs}.{played_balls} Ov Played)\n"
...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'solo_game':
        ...
        if roll <= 60: # 60% WIDE
            ...
            await query.edit_message_text("🎯 <b>You landed a perfect YORKER!</b> Let's see how the batter reacts...", parse_mode='HTML', reply_markup=InlineKeyboardMarkup([]))
