...
def generate_team_scorecard(game):
    ...
    for team_key, team_name in [("team_a", "🔴 TEAM A"), ("team_b", "🔵 TEAM B")]:
        ...
        played_overs, played_balls = divmod(opp_team["balls_bowled"], 6) if opp_team else (0, 0)
    ...
    if chat_type == "private":
        ...
        if is_over_complete:
            ...
            if game.get("mode") == "TEAM":
                ...
                # Check if striker exists (might have gotten out on the last ball)
                if game.get("striker"):
